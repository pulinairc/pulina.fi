...
<div class="slide slide-games">
  ...
  <!-- <div class="video-overlay js-video-overlay" style="background-image: url('https://img.youtube.com/vi/DKvh_IwG7o4/maxresdefault.jpg');"></div> -->
  ...
  <div class="container">
    ...
    <h2>Uutta: Moninpelit</h2>
    <p>Pulinalla on lukuisia aktiivisia pelaajia. Jotta kaikki pääsisivät mukaan, suosimme selainpelejä tai avoimen lähdekoodin pelejä kuten <a href="https://xonotic.org/">Xonotic</a>. Pelailemme säännöllisen epäsäännöllisesti.</p>

    <p><a href="<?php echo get_page_link(1287); ?>" class="button button-ghost">Tule mukaan pelaamaan!</a></p>
  </div>
...
<div class="slide slide-telegram">
  ...
  <div class="container">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 240 240"><defs><linearGradient id="ba" x1=".667" y1=".167" x2=".417" y2=".75"><stop stop-color="#37aee2" offset="0"/><stop stop-color="#1e96c8" offset="1"/></linearGradient><linearGradient id="bb" x1=".66" y1=".437" x2=".851" y2=".802"><stop stop-color="#eff7fc" offset="0"/><stop stop-color="#fff" offset="1"/></linearGradient></defs><circle cx="120" cy="120" r="120" fill="url(#ba)"/><path fill="#c8daea" d="M98 175c-3.888 0-3.227-1.468-4.568-5.17L82 132.207 170 80"/><path fill="#a9c9dd" d="M98 175c3 0 4.325-1.372 6-3l16-15.558-19.958-12.035"/><path fill="url(#bb)" d="M100.04 144.41l48.36 35.729c5.519 3.045 9.501 1.468 10.876-5.123l19.685-92.763c2.015-8.08-3.08-11.746-8.36-9.349l-115.59 44.571c-7.89 3.165-7.843 7.567-1.438 9.528l29.663 9.259 68.673-43.325c3.242-1.966 6.218-.91 3.776 1.258"/></svg>
