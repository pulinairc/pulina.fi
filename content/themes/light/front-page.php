...
<div class="slide slide-irc-clients" id="aloita">    
  ...
  <div class="container">    
    <div class="col">
      ...
      <a class="link thelounge" href="https://chat.pulina.fi" aria-label="The Lounge"><?php include get_theme_file_path( '/svg/thelounge.svg' ); ?></a>
    </div>
  </div>
</div>
...
<?php get_template_part( 'template-parts/games/general' ); ?>
