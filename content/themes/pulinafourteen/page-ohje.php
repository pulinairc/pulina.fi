		...
		<?php while ( have_posts() ) : the_post(); ?>
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				...
				<div class="row">
					...
					<p>Pulinalle pääsee kaikista nopeiten ja helpoiten tällä hetkellä käyttämällä <a href="http://webchat.quakenet.org/?channels=#pulina" target="_blank">webchattia</a>:

					<p><a href="http://webchat.quakenet.org/?channels=#pulina" class="btn join-btn">Irkkiin nyt heti!</a></p>
